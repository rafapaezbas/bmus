...
const { readTrackMetadata } = require('./utils.js')

class Player extends ReadyResource {
  constructor(onTrackEnd, onError) {
    super()
    this.playlist = []
    this.currentIndex = -1
    this.random = false
